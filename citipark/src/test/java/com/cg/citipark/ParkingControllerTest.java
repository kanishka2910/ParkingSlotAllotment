...
import com.cg.citipark.service.ParkingServiceImpl;
...
public class ParkingControllerTest {
	...
	public void setMockData()
	{
		...
		pS1=new ParkingSlots(2,null,pDate,"17:00",date,4,null);
		
		LocalDate date1=LocalDate.now();
		LocalDate pDate1= LocalDate.of(2020, 02, 24);
		pS2=new ParkingSlots(3,null,pDate1,"17:00",date1,5,null);
	...
	void testDeleteSlot()
	{
		ResponseEntity<ParkingSlots> postResponse = restTemplate.postForEntity(getRootUrl() + "/api/bookslot", pS2,
				ParkingSlots.class);
		ParkingSlots pS3=restTemplate.getForObject(getRootUrl()+"/api/getSlotById/3", ParkingSlots.class);
		restTemplate.delete(getRootUrl()+"/api/getSlotById/3", ParkingSlots.class);
		ParkingSlots pS4=restTemplate.getForObject(getRootUrl()+"/api/getSlotById/3", ParkingSlots.class);
		assertEquals(null, pS4);
	}
